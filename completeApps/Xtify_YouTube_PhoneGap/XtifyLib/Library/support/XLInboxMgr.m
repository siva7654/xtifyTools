...
- (void)successGetMessageMethod:(ASIHTTPRequest *) request 
{
    ...
    NSString *strData = [[[NSString alloc]initWithData:response encoding:NSUTF8StringEncoding] autorelease];

    XTLOG(@"responseString=%@",strData );
	XLInboxJsonParser *inboxJsonParser = [[[XLInboxJsonParser alloc] init] autorelease];
